# Architectural Teardown: PhonePe Fraud Detection System

*(Perspective: Senior AI Systems Architect — Payments / Risk Systems)*

Fraud detection in UPI-scale systems is a **real-time risk scoring problem under strict latency constraints (~50–150ms)** with extreme class imbalance (<0.5% fraud rate) and adversarial actors actively adapting.
...
* Break this into a full production architecture diagram (component-level)
* Design this as a portfolio-ready fraud detection project
* Or simulate how an internal design review discussion would critique this system
